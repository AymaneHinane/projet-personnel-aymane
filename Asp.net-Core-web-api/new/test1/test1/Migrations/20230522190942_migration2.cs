    ...
    public partial class migration2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Category", x => x.BookId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BookId = table.Column<int>(type: "int", nullable: false),
                    CategoriesBookId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCategory", x => new { x.BookId, x.CategoriesBookId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCategory_Category_CategoriesBookId",
                        column: x => x.CategoriesBookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCategory_CategoriesBookId",
                table: "BookCategory",
                column: "CategoriesBookId");
