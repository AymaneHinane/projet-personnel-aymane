        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CheckCity", "[ZipCode] > 10000");
                    table.CheckConstraint("CheckCountry", "[Country] = 'Maroc'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fuel_Economy = table.Column<bool>(type: "bit", nullable: true),
                    EngineType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClothesCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Mark = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    clothesSize = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Size = table.Column<int>(type: "int", nullable: true),
                    ElectronicsCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("AvailableQuantityLimitation", " [AvailableQuantity] > 0 ");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CheckOrderDate", "[DeliveryDate] > [OrderDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("QuantityOrderCheck", " [Quantity] > 0 ");
                    table.ForeignKey(
